...
var AsyncProps = _react2['default'].createClass({
  ...
  loadAsyncProps: (function (_loadAsyncProps) {
    function loadAsyncProps(_x, _x2, _x3) {
      return _loadAsyncProps.apply(this, arguments);
    }

    loadAsyncProps.toString = function () {
      return _loadAsyncProps.toString();
    };

    return loadAsyncProps;
  })(function (components, params, cb) {
    var _this2 = this;
    ...
    this.beforeLoad(function () {
      _this2.inflightLoader = loadAsyncProps(components, params, function (err, asyncProps) {
